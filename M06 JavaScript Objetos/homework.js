...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
  // Crear un nuevo objeto (primera solicitud) con la propiedad "nombre" (es la propiedad (la propiedad es la 
  // llamada clave) que se encuentra contenido adentro de objeto) y el valor definido como 
  //el argumento "nombre" (es el argumento que va a ir a la propiedad).
...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
   objeto[metodo]()
   //Explicacion de este ejercicio: Recuerda un método es una función, solo que se le llama método.
   //Una función se invoca declarándola así funcion()
   //El ejercicio te pide que invoques un método al objeto (ambos por parámetro)
   //Y la única manera de invocar la propiedad recibida por parametro es bracket notation
   //Así las cosas objeto[EL NOMBRE RECIBIDO POR PARÁMETRO]() 
}
